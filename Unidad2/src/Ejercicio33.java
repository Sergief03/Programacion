...
public class Ejercicio33 {
    public static void main(String[] args) {
        ...
        try {
            ...
            Reproductor reproductor1 = new Reproductor(archivo1, true, true);
            reproductor1.play();
            Reproductor reproductor2 = new Reproductor(archivo2, true, true);
            reproductor2.play();
            Reproductor reproductor3 = new Reproductor(archivo3, true, true);
            reproductor3.play();
        } catch (IOException e) {
